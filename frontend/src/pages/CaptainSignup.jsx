    ...
    return (
        <div>
            <div className='py-5 px-5 h-screen flex flex-col justify-between' >
                ...
                <div>
                    <p className='text-[10px] mt-6 leading-tight'>This site is protected by rePAPTCHA and the <span className='underline'>Google Policy</span> and <span className='underline'>Term of Service apply</span>.
                    </p>
                </div>
            </div>
        </div>
